...
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.fileImage1
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.fileImage2
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.fileImage3
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idCatatan
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idCategory
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idMotif
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idPeristiwa
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idProject
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idRig
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idStatusRig
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idSumber
import com.example.arief.securityonline.presentation.main.bottomnavigationbar.writereport.WriteReportFragment.Companion.idSumur
...
class WriteReportPresenter (iViewWriteReport: BaseInterface.IWritePresenter){
    ...
    private fun uploadSpinner():MutableMap<String, RequestBody> {
        ...
        //Dummy
        map["id_propinsi"] = "1100000000".toRequestBody("multipart/form-data".toMediaTypeOrNull())
        map["id_kab_kota"] = "9114000000".toRequestBody("multipart/form-data".toMediaTypeOrNull())
        map["id_kecamatan"] = "8201010000".toRequestBody("multipart/form-data".toMediaTypeOrNull())
        map["id_wilayah"] = "9101012008".toRequestBody("multipart/form-data".toMediaTypeOrNull())
